...
print("[cyan]Register readpdf udf")
print("[cyan]=============================")
arguments = argparse.ArgumentParser()
arguments.add_argument("--udfname",default="readpdf",help="Register an udf that can then be used to read the pdf content")
...
session.udf.register_from_file(file_path="readpdf.py", func_name="readpdf"
, name = args.udfname
...
SELECT {session.get_fully_qualified_current_schema()}.{args.udfname}('{filename}')
""")